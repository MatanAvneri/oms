...
`),X=()=>{const e=y(),t=b.useContext(N);return console.log("colorMode.toggleColorMode",t.toggleColorMode),b.createElement(Z,null,b.createElement(S,{injectFirst:!0},b.createElement(Q,null,b.createElement(C,{sx:{position:"absolute",top:0,left:0},onClick:t.toggleColorMode,color:"inherit"},"dark"===e.palette.mode?b.createElement(z,null):b.createElement(w,null)),b.createElement(V,null),b.createElement(P,null),b.createElement(K,null))))},Z=({children:e})=>{const t=B("(prefers-color-scheme: dark)"),[r,o]=b.useState(t?"dark":"light"),l=b.useMemo((()=>({toggleColorMode:()=>{console.log("toggling"),o("light"===r?"dark":"light")}})),[]),n=b.useMemo((()=>k({palette:{mode:r}})),[r]);return b.createElement(N.Provider,{value:l},b.createElement(j,{theme:n},e))};u.render(b.createElement(b.StrictMode,null,b.createElement(X,null)),document.getElementById("root"));
